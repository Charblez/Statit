...
@Service
public class WeightGlobalDatasetProvider implements GlobalDatasetProvider
{
    public WeightGlobalDatasetProvider(GlobalDatasetPointService globalDatasetPointService)
    {
    ...
    {
        return NhanesDatasetSeeder.WEIGHT_SOURCE_KEY;
    }
    ...
    public GlobalDatasetSnapshot getSnapshot(Map<String, String> tags)
    {
        return globalDatasetPointService.buildSnapshot(
                sourceKey(),
                NhanesDatasetSeeder.NHANES_SOURCE_NAME + " - Weight",
